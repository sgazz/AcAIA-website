...
exports.getRandomAIResponse = exports.getMockExams = exports.getMockProblems = exports.getMockChatsByUserId = exports.getMockUserByEmail = exports.getMockUserById = exports.mockAIResponses = exports.mockLearningPaths = exports.mockCareerPaths = exports.mockExams = exports.mockProblems = exports.mockChats = exports.mockUsers = void 0;
exports.mockUsers = [
    {
        _id: 'mock-user-1',
...
const getMockUserById = (id) => {
    return exports.mockUsers.find(user => user._id === id);
};
exports.getMockUserById = getMockUserById;
const getMockUserByEmail = (email) => {
    return exports.mockUsers.find(user => user.email === email);
};
exports.getMockUserByEmail = getMockUserByEmail;
const getMockChatsByUserId = (userId) => {
    return exports.mockChats.filter(chat => chat.userId === userId);
};
exports.getMockChatsByUserId = getMockChatsByUserId;
const getMockProblems = () => {
    return exports.mockProblems;
};
exports.getMockProblems = getMockProblems;
const getMockExams = () => {
    return exports.mockExams;
};
exports.getMockExams = getMockExams;
const getRandomAIResponse = (type) => {
    const responses = exports.mockAIResponses[type];
    return responses[Math.floor(Math.random() * responses.length)];
};
exports.getRandomAIResponse = getRandomAIResponse;
